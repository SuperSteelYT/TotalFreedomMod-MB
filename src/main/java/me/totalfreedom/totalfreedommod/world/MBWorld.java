...
public final class MBWorld extends CustomWorld
{
    ...
    private static final String WORLD_NAME = "mbworld";
    //
    ...
    protected World generateWorld()
    {
        ...
        welcomeSign.setLine(0, ChatColor.DARK_AQUA + "MBWorld");
    ...
    public boolean validateMovement(PlayerMoveEvent event)
    {
        ...
        if (lastTP == null || lastTP + TP_COOLDOWN_TIME <= currentTimeMillis)
        {
            ...
            FLog.info(player.getName() + " attempted to access the MBWorld.");
